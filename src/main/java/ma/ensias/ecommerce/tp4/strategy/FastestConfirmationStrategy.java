...
public class FastestConfirmationStrategy implements GatewaySelectionStrategy {
    @Override
    public PaymentGateway selectGateway(CheckoutContext context, List<PaymentGateway> gateways) {
        return gateways.stream()
            ...
            .min(
                Comparator
                    .comparingInt((PaymentGateway gateway) -> gateway.estimateConfirmationDelayMinutes(context))
    ...
    public String getName() {
        return "FastestConfirmationStrategy";
    }
}
